...
set_target_properties(SFML::System PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib64/libsfml-system.so.3.0.0"
  IMPORTED_SONAME_RELEASE "libsfml-system.so.3.0"
  )

list(APPEND _cmake_import_check_targets SFML::System )
list(APPEND _cmake_import_check_files_for_SFML::System "${_IMPORT_PREFIX}/lib64/libsfml-system.so.3.0.0" )

# Import target "SFML::Window" for configuration "Release"
set_property(TARGET SFML::Window APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
set_target_properties(SFML::Window PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib64/libsfml-window.so.3.0.0"
  IMPORTED_SONAME_RELEASE "libsfml-window.so.3.0"
  )

list(APPEND _cmake_import_check_targets SFML::Window )
list(APPEND _cmake_import_check_files_for_SFML::Window "${_IMPORT_PREFIX}/lib64/libsfml-window.so.3.0.0" )
...
set_target_properties(SFML::Network PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib64/libsfml-network.so.3.0.0"
  IMPORTED_SONAME_RELEASE "libsfml-network.so.3.0"
  )

list(APPEND _cmake_import_check_targets SFML::Network )
list(APPEND _cmake_import_check_files_for_SFML::Network "${_IMPORT_PREFIX}/lib64/libsfml-network.so.3.0.0" )
...
set_target_properties(SFML::Graphics PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib64/libsfml-graphics.so.3.0.0"
  IMPORTED_SONAME_RELEASE "libsfml-graphics.so.3.0"
  )

list(APPEND _cmake_import_check_targets SFML::Graphics )
list(APPEND _cmake_import_check_files_for_SFML::Graphics "${_IMPORT_PREFIX}/lib64/libsfml-graphics.so.3.0.0" )
...
set_target_properties(SFML::Audio PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib64/libsfml-audio.so.3.0.0"
  IMPORTED_SONAME_RELEASE "libsfml-audio.so.3.0"
  )

list(APPEND _cmake_import_check_targets SFML::Audio )
list(APPEND _cmake_import_check_files_for_SFML::Audio "${_IMPORT_PREFIX}/lib64/libsfml-audio.so.3.0.0" )
